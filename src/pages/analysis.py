...
def show_analysis(matrix_dict, all_archetypes, records_data):
    ...
    with c_chart:
        ...
        if not df_prof.empty:
            ...
            st.info("Nedostatek dat pro distribuci.")

    with c_table:
        st.subheader("Detailní rozpis")
        df_prof_display = df_prof[["Opponent", "Win Rate", "Record", "Games"]].copy()
        df_prof_display = df_prof_display.fillna("—")
