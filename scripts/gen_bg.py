"""Regenerates src/bg_data.py with Black Lotus."""
import base64, pathlib
from PIL import Image, ImageEnhance, ImageOps

root = pathlib.Path(__file__).parent.parent
img_path = root / "assets" / "bg.jpg"
src_path = pathlib.Path(r"C:\Users\MartinGrossmann\.gemini\antigravity\brain\699dfad3-8429-4a34-8c9f-c66ce122260c\media__1771771560263.jpg")
...
out_path.write_text(f'BG_MASTICORE_V4_B64 = "{b64}"\n')
